...
export class PageValidator {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        PageValidatorFinalization.unregister(this);
        return ptr;
    }
    free() {
    ...
    constructor(schema_json) {
        ...
        const ret = wasm.pagevalidator_new(ptr0, len0);
        if (ret[2]) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('page_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
