...
function validateString(
  ...
  if (
    ...
    errors.push({
      ...
      code: 'MIN_LENGTH',
      message:
        `Field "${fieldName}" must have at least ${definition.minLength} characters.`,
    })
  }
  ...
  if (
    ...
    errors.push({
      ...
      code: 'MAX_LENGTH',
      message:
        `Field "${fieldName}" must have at most ${definition.maxLength} characters.`,
    })
  }
...
function validateNumber(
  ...
  if (
    ...
    errors.push({
      ...
      code: 'MINIMUM',
      message:
        `Field "${fieldName}" must be greater than or equal to ${definition.minimum}.`,
    })
  }
  ...
  if (
    ...
    errors.push({
      ...
      code: 'MAXIMUM',
      message:
        `Field "${fieldName}" must be less than or equal to ${definition.maximum}.`,
    })
  }
}
...
function validateChildren(
  ...
  if (
    ...
    errors.push({
      ...
      code: 'MIN_CHILDREN',
      message:
        `Component must have at least ${component.minChildren} children.`,
    })
  }
  ...
  if (
    ...
    errors.push({
      ...
      code: 'MAX_CHILDREN',
      message:
        `Component must have at most ${component.maxChildren} children.`,
    })
  }
  ...
  for (
    ...
    if (
      ...
      errors.push({
        ...
        message:
          `Child component "${child.type}" is not allowed here.`,
      })
    }
  }
}